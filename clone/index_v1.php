    ...
    <div class="bg-[#050505] border-b border-white/5 px-6 py-2.5 flex justify-between items-center relative z-50">
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hidden sm:flex items-center gap-1.5 opacity-50 hover:opacity-100 transition-opacity cursor-help" title="Server Region: Manila">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-cyberlime" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                    <span class="text-[8px] font-mono text-white tracking-wider">MNL-01</span>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div class="lg:col-span-2 p-8 rounded-2xl bg-[#161b22] border border-gray-800 shadow-2xl">
                        ...
                        <form action="process_add_car.php" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            ...
                            <div class="w-full">
                                <label class="text-[9px] text-gray-500 uppercase font-bold mb-2 block">Brand</label>
                                <select id="make-select" name="make" class="input-facundo" required>
                            ...
                            <div class="w-full">
                                <label class="text-[9px] text-gray-500 uppercase font-bold mb-2 block">Model</label>
                                <select id="model-select" name="model" class="input-facundo" required></select>
                            </div>

                            <div class="w-full">
                                <label class="text-[9px] text-gray-500 uppercase font-bold mb-2 block">Transmission</label>
                                <select id="transmission-select" name="transmission" class="input-facundo">
                            ...
                            <div class="w-full">
                                <label class="text-[9px] text-gray-500 uppercase font-bold mb-2 block">Fuel Type</label>
                                <select id="fuel-select" name="fuel" class="input-facundo">
                            ...
                            <div class="w-full">
                                <label class="text-[9px] text-gray-500 uppercase font-bold mb-2 block">Year</label>
                                <select id="year-select" name="year" class="input-facundo">
                                    <?php for($y = date('Y')+1; $y >= 1995; $y--) echo "<option value='$y'>$y</option>"; ?>
                                </select>
                            </div>

                            <div class="w-full">
                                <label class="text-[9px] text-gray-500 uppercase font-bold mb-2 block">Price (PHP)</label>
                                <input type="number" name="price" class="input-facundo" placeholder="0.00" required>
                            </div>
                            <div class="w-full">
                                <label class="text-[9px] text-gray-500 uppercase font-bold mb-2 block">Mileage (KM)</label>
                                <input type="number" name="mileage" class="input-facundo" placeholder="0" required>
                            </div>
                    ...
                    <div class="space-y-6">
                        <?php 
                            ...
                            try {
                                ...
                                // Silent fail to keep page running
                            }
                        ?>
                        
                        <div class="bg-[#161b22] p-8 rounded-xl border border-gray-800">
                            <span class="text-gray-500 text-[10px] font-bold uppercase tracking-[0.2em]">Inventory Value</span>
                            <div class="text-3xl font-black mt-2 text-white">₱<?php echo number_format($total_val); ?></div>
                        </div>
                        
                        <div class="bg-[#161b22] p-8 rounded-xl border border-gray-800">
                            <span class="text-gray-500 text-[10px] font-bold uppercase tracking-[0.2em]">Active Units</span>
                            <div class="text-3xl font-black mt-2 text-white"><?php echo number_format($total_cnt); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            ?>
                                        <div class="p-4 bg-[#0d1117] border-l-2 border-cyberlime rounded-r-xl group hover:bg-white/[0.01] transition-all relative">
                                            <div class="flex justify-between mb-2">
                                                <span class="text-[9px] font-black text-cyberlime uppercase tracking-tighter">From: <?php echo $name; ?></span>
                                                <span class="text-[8px] text-gray-600 font-mono"><?php echo date('H:i | M d', strtotime($m['created_at'])); ?></span>
                                            </div>
                                            <p class="text-gray-300 text-xs leading-relaxed mb-3"><?php echo htmlspecialchars($m['message']); ?></p>
                                            
                                            <?php if($isUserMessage): ?>
                                                <div class="flex justify-end">
                                                    <button 
                                                        type="button"
                                                        onclick="window.openAdminReply(<?php echo $m['sender_id']; ?>, '<?php echo htmlspecialchars($name, ENT_QUOTES); ?>')" 
     ...
     <section id="finance" class="py-24 px-6 bg-black border-t border-gray-900 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto relative z-10">
                <div class="mb-16 text-center">
                    ...
                    <h3 class="text-4xl md:text-5xl font-black italic uppercase tracking-tighter text-white">Payment <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyberlime to-white">Solutions</span></h3>
                </div>
